...
description: Generate videos with Minimax in Claude. Use when the user wants image-to-video generation, or needs the agent to start a background video task, poll until it finishes, and return the final download URL.
---
