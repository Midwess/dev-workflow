...
- project-guidelines-auditor, bug-detector, history-analyzer, spec-validator
...
Launch review agents in parallel using Codex agent delegation based on review mode:

#### Core Agents (all modes)

**Agent 1: Project Guidelines Compliance (project-guidelines-auditor)**
- Provide: `.dev/project.md` content
- Provide: `AGENTS.md` and `CLAUDE.md` if present
...
### Agents Used
**Core:**
- project-guidelines-auditor: {issues found}
...
### Checks Performed
- Project guidance compliance (`AGENTS.md`, `CLAUDE.md`, `.dev/project.md`)
- Bug detection
