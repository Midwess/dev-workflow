...
**Other indicators:**
- `AGENTS.md` or `CLAUDE.md` - Project has repository guidance
...
**Ask the user directly with one concise question:**
```
...
Delegate to the `code-explorer` agent when the user chooses Deep:
