...
Ask the user one concise question at a time for each step:
...
**Auto-delegate to code-explorer when useful:**

Display to user: "Analyzing codebase for relevant patterns..."

Delegate to the `code-explorer` agent with:
...
**Auto-delegate to code-architect when useful:**

Display to user: "Designing implementation architecture..."

Delegate to the `code-architect` agent with:
